...
2. On the  **Get temporary password** page, write down the value displayed in the **NEW PASSWORD** text box.
...
2. On the  **Get temporary password** page, note the value displayed in the **NEW PASSWORD** text box.
...
1. This redirects you to the Azure portal interface. 

2. In the Azure portal interface, in the  **Hub** menu, click **Browse**.

3. Scroll down the list of resources, and then click  **Subscriptions**.

4. In the  **Subscriptions** blade, click your subscription.

5. Note that you can view all details of the subscription, including  **Breakdown of current charges**.

6. Click  **All settings**.

7. In the  **Settings** blade, click **Users**.
Note that you have full access to the  **Users** blade.

8. Click the  **user name** in the upper-right corner, and then click **Sign out** in the drop down menu.

9. On the Microsoft Azure page, click  **Use another account**.

10. When prompted to authenticate, in the Email or phone text box, enter the full user name of the  **kari** Azure AD user account, including the suffix following the **@** symbol.

11. In the Password text box, enter the password you noted when creating the kari user account and then click  **Sign in**.

12. You will be redirected to the Update your password page. Enter the following details and then click  **Update password and sign in**:
...
1. In the Azure portal interface, in the Hub menu, click  **Browse.**

2. Scroll down the list of resources, and then click  **Subscriptions**.

3. In the  **Subscriptions** blade, notice the message, **You don't have any subscriptions.**
...
4. Click the  **user name** in the upper-right corner and click **Sign out** in the drop-down menu.

5. Close the Internet Explorer InPrivate Browsing session window.
