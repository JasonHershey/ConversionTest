...
1.   Your phone will ring. Answer the call, and then press # on your phone keyboard. After confirming your identity on the phone, you should be connected.
...
**Question** 
When a user resets the password by using the Azure AD profile page, what should you enable to maintain password consistency in Azure AD and ADÂ DS?
