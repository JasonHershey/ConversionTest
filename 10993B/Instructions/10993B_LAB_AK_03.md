...
14.   In the  **Accounts** window, click **Email &amp; app accounts**, and in the  **details** pane, click **account** **Annie@_yourdomain.hostdomain_.com**, and then click **Manage**.
...
4.   In the  **Windows PowerShell Credential** dialog box, enter the following credentials, and then click **OK**:
    -   User name: **msnider@_Adatumyyxxxxx_.onmicrosoft.com**
...
17.   On the  **Microsoft Azure** page, type **Abbi@_yourdomain.hostdomain_.com**, and then click  **Continue**.
