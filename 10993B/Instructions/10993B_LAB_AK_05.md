...
12.   Click  **Close**.
13.   Restart the computer and then sign in again as  **Adam@_yourdomain.hostdomain_.com**. On the  **Set up a PIN** page, click **Set up PIN**. Close the  **Help us protect your account** window, and then click **Skip for now**.
...
3.   Sign in as  **Adam@_yourdomain.hostdomain_.com**. If prompted, set up an alternative authentication option to your mobile phone, as you did in the previous labs.
