...
5. Identify the name of the Azure subscription to which you deployed virtual machines in the previous task of this exercise, type in the following cmdlet, and then press Enter (replace  _â€˜Name of your subscription'_ with the actual name of your subscription and make sure to enclose the name of your subscription in single quotes):
...
5. On the ResDevRG blade, in the Summary section, view the  **Resource** list. Click the ellipsis (â€¦) in the lower-right corner to see all of the resources in this resource group.
