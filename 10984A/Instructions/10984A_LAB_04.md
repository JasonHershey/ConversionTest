...
4.  On **LON-CL1**, sign in as **Adatum\\Beth** with the password**Pa55w.rd**, from the taskbar, open Microsoft Edge, and then navigate to [https://aka.ms/AA2p30o](https://aka.ms/AA2p30o).
...
5.  In the **Credentials** dialog box, type **Administrator** for the **User name**, type **Pa55w.rd** for the **password**, and then select **OK**.
