...
7. Type the following command, and then press Enter.
  ...
  ```
  New-AzureSqlDatabaseServer -AdministratorLogin â€˜yourname' -AdministratorLoginPassword â€˜Pa$$w0rd' -Location â€˜YourRegion'
  ```
...
```
New-AzureStorageAccount -StorageAccountName â€˜cloudappprodxxx' -Location â€˜Your Region'
```
...
```
Test-AzureName -Storage â€˜cloudappprodxxx'
```
